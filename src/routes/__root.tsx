...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Moteles Villavicencio · Punto G · Loma Verde · Palo Alto Glamping" },
      { name: "description", content: "Experiencia cinematográfica de reserva para PUNTO G, LOMA VERDE y PALO ALTO GLAMPING en Villavicencio. Habitaciones, servicios y reservas por WhatsApp." },
      { property: "og:title", content: "Moteles Villavicencio · Punto G · Loma Verde · Palo Alto Glamping" },
      { property: "og:description", content: "Tres refugios exclusivos en Villavicencio. Reserva discreta y elegante." },
